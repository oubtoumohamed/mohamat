...
@section('content')
  ...
  <form class="card" method="POST" enctype="multipart/form-data" articleion="@if($object->id){{ route('article_update',$object->id) }}@else{{ route('article_store') }}@endif">
    {{ csrf_field() }}
...
<script>
  var editor_config = {
    ...
    file_browser_callback : function(field_name, url, type, win) {
      ...
      tinyMCE.articleiveEditor.windowManager.open({
        file : cmsURL,
        title : 'File Manager',
        width : x * 0.8,
        height : y * 0.8,
