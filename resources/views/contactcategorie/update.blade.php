...
@section('content')
  ...
  <form class="card" method="POST" enctype="multipart/form-data" action="@if($object->id){{ route('contactcategorie_update',$object->id) }}@else{{ route('contactcategorie_store') }}@endif">
    {{ csrf_field() }}
